...
* [x] When the user tries to tweet a text longet than 140 character we display a toast and don't leave the compose activity
* [x] Using ItemDecoration to separate every tweet

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='http://i.imgur.com/e3ed0aae-0c70-4127-90fa-e227444f59fa.gif' title='Video Walkthrough' width='600' alt='Video Walkthrough' />
[Link to GIF Walkthrough](https://i.imgur.com/f16Mx3m.gif)
